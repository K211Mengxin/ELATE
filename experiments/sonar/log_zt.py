...
data['tem']=tem
data['E_l']=g_t
data['var_l']=smc_data['var_mean']
data['post_mean_l']=elate['post_mean'][:,0]
data['post_var_l']=elate['post_var'][:,0]

data['E_z']=log_zt
data['var_z']=var_logzt
data['post_mean_z']=elate_v2['post_mean']
data['post_var_z']=elate_v2['post_var'].squeeze()
